...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // Form Wizard
        var form = $("#form-wizard-comisionista");
        form.validate({
        ...
        form.children(".wizard").steps({
            ...
            onFinished: function(event, currentIndex) {
                ...
                $.ajax({
                    ...
                    data: $("#form-wizard-comisionista").serialize(),
                    type: "post",
                    dataType: "json",
                    success: function(respuesta){
                        ...
                        if(respuesta.success == true){
                            bootbox.alert({
                                message: "<h3><i class='fas fa-check-circle' style='color:#13b313'></i> Comisionista modificado exitosamente.</h3>",
                                locale: 'mx'
                            });
