$(function(){
    bootbox.alert({
        ...
        'TRANSFERENCIAS A OTRAS CUENTAS O BANCOS INTERNACIONALES:<br><br>'+
        '1.- Banco Beneficiario.<br> 2.- Código SWIFT/BIC. <br> 3.- Cuenta Beneficiario. <br> 4.- Nombre Beneficiario. <br> 5.- Dirección Beneficiario. <br> 6.- Ciudad, Estado, País.',
        locale: 'mx'
    });
