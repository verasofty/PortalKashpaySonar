$(function(){
    ...
    $(".buscar").click(function(event) {
        ...
        table.clear().draw();
        $.ajax({
            url: base_url+"/listEntidad/searchResult",
                ...
                if(data1.rows.success == true){
                    //if (data1.rows != null) {                    
                        ...
                        for (var i=0; i < data1.rows.commerces.length; i++) { 
                            if(data1.rows.commerces[i].idBusinessModel == 1){
                                modelo = 'Emisor';
                            }else if(data1.rows.commerces[i].idBusinessModel == 2){
                                modelo = 'Adquirente';
                            }else if(data1.rows.commerces[i].idBusinessModel == 3){
                                modelo = 'Mixto';
                            }

                          if(data1.rows.commerces[i].idBusinessModel != 2){
                             segmento = '<li>'+
                            ...
                            var datadni = [
                                    ...
                                    '<div class="btn-group">'+
                                      ...
                                      '<ul class="dropdown-menu" role="menu">'+
                                            '<li>'+
                                                '<a href="editarCuenta?validate='+data1.rows.commerces[i].entitySonID+'&level=4">'+
                                                  'Editar Información'+
                                                '</a>'+
                                            '</li>'+
                                            segmento+
