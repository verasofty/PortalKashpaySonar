$(function(){
   bootbox.alert({
        title: '¡Importante!',
        message: 'Traspasos a cuentas KashPay y cuentas propias: <br><br> '+
        '1.- CLABE Interbancaria. Utilizar para traspasos a Sub afiliados, Entidades, Sucursales, Cajas.<br>2.- Número de celular vinculado a su cuenta.<br>3.- Número de Tarjeta.<br><br>'+
        'Transferencias Interbancarias a otras cuentas o bancos:<br><br>'+
        '1.- CLABE Interbancaria - 18 dígitos.<br>2.- Número de tarjeta de débito - 16 dígitos.<br>3.- Número de celular (asociado a la cuenta destino)<br><br><br><br><p style="color:red;font-size: 13px;">Para finalizar el envío, recibirás un TOKEN de confirmación al correo y teléfono '+telS+' que fue registrado a esta cuenta</p>',
        locale: 'mx'
    });
    var idOrigin = '';
    var numCuenta = '';
                    ...
                    + '<div class="row allcp-form" >'
                      + '<div class="form-group" style="width:100%;">'
                          +' <div class="col-md-12 section">'+
                              ...
                              '<div class="col-md-12">'+
                                '<div class="form-group">'+
                                  '<p>TRASPASOS A CUENTAS DE TERCEROS Y CUENTAS PROPIAS NACIONALES DE MEXICO: <br><br> '+
                                  '1.- Número de Celular Vinculado a su Cuenta.<br>2.- Número de Tarjeta Vinculada a la APP KASHPAY.<br><br>'+
                                  'TRANSFERENCIAS INTERBANCARIAS A OTRAS CUENTAS O BANCOS NACIONALES DE MEXICO:<br><br>'+
                                  '1.- Clabe Interbancaria - 18 dÍgitos.<br> 2.- Número de Tarjeta de Débito - 16 dígitos.</p>'+
                                '</div>'+
                              '</div>'+
                            '</div>'
                      + '</div>'
                    ...
                    success: function(respuesta){
                        if (respuesta.success == true) {
                            ...
                            if (respuesta.institutionResponse.institutions.length == 1) {
                                ...
                                $('#accountNumber').val(respuesta.institutionResponse.idEntity);
                            }else{
