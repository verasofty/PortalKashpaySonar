$(function(){
    ...
    $('.verDetalle').click(function(event) {
            ...
            $.ajax({
                url: base_url+"/nominaDetalle/detalleDispercion/"+idDispersion,
                type: "post",
                dataType: "json",
                cache: false,
                contentType: false,
    ...
    $("#btnLimpiar").click(function(event) {
       ...
       $("#form_filtro")[0].reset();
       location.href = base_url+'/listarNomina?name=&date=&page=1';
    });
    ...
    $('.buscar').click(function(event) {
       ...
       if ($('#name').val() != '') {
        ...
        if (countError <= 1) {
            location.href = base_url+'/listarNomina'+urlSearch+'&page=1';
