$(function(){
    ...
    $('#divMonFac').hide();
        ...
        var valTipo = $('input[name=facturacion]:checked', '#form-wizard-caja').val();
        ...
        if(valTipo == 'facturacion') {
            ...
            $('#divMonFac').hide();
            $('#perFac').val('');
            document.querySelectorAll('input[name=diasFac]', '#form-wizard-caja').forEach(function(checkElement) {
        ...
        var valTipoF = $('input[name=facTrans]:checked', '#form-wizard-caja').val();
        ...
        var valTipoM = $('input[name=modelo]:checked', '#form-wizard-caja').val();
        switch(valTipoM) {
            case '1': //Emisor
                $('.divElemento').show();
        ...
        var valTipoD = $('input[name=dispersion]:checked', '#form-wizard-caja').val();
        switch(valTipoD) {
            case 'en':
                $('.divElemento').show();
                $('.divCuentaFuera').hide();
    ...
    $('.facTransa').on('change', function() {
        var valTipo = $('input[name=facTrans]:checked', '#form-wizard-caja').val();
    ...
    $('.tipoModelo').on('change', function() {
        var valTipo = $('input[name=modelo]:checked', '#form-wizard-caja').val();
        switch(valTipo) {
            case '1': //Emisor
                $('.divElemento').show();
                $('#cuentaDes').html($('<option>').val('CONC_ADQUI').text('Cuenta Emisor'));
    ...
    $('.tipoDis').on('change', function() {
        var valTipo = $('input[name=dispersion]:checked', '#form-wizard-caja').val();
        switch(valTipo) {
            case 'en':
                $('.divElemento').show();
                $('.divCuentaFuera').hide();
    ...
    var cp2 = '';
    var cpSelect = '';
	console.log('idLocalidad'+idLocalidadSelected);
    if(idLocalidadSelected != '' && idLocalidadSelected != 'ND'){
        $.ajax({
