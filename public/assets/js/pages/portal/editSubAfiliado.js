$(function(){
    ...
    var valTipo = $('input[name=facturacion]:checked', '#form-wizard-subafiliado').val();
        ...
        if(valTipo == 'facturacion') {
            ...
            $('#divMonFac').hide();
            $('#perFac').val('');
            document.querySelectorAll('input[name=diasFac]', '#form-wizard-subafiliado').forEach(function(checkElement) {
        ...
        var valTipoF = $('input[name=facTrans]:checked', '#form-wizard-subafiliado').val();
        ...
        var valTipoM = $('input[name=modelo]:checked', '#form-wizard-subafiliado').val();
        switch(valTipoM) {
            case '1': //Emisor
                $('.divElemento').show();
        ...
        var valTipoD = $('input[name=dispersion]:checked', '#form-wizard-subafiliado').val();
        switch(valTipoD) {
            case 'en':
                $('.divElemento').show();
                $('.divCuentaFuera').hide();
    ...
    $('.facTransa').on('change', function() {
        var valTipo = $('input[name=facTrans]:checked', '#form-wizard-subafiliado').val();
    ...
    $('.tipoModelo').on('change', function() {
        var valTipo = $('input[name=modelo]:checked', '#form-wizard-subafiliado').val();
        switch(valTipo) {
            case '1': //Emisor
                $('.divElemento').show();
                $('#cuentaDes').html($('<option>').val('CONC_ADQUI').text('Cuenta Emisor'));
