    ...
    $(document).ready(function() {
        ...
        form.children(".wizard").steps({
            ...
            onFinished: function(event, currentIndex) {
                ...
                $.ajax({
                    url: base_url+"/addComisionista/registrar",
                    type: "post",
                    dataType: "json",
                    data: formData,
                    cache: false,
                    ...
                    success: function(respuesta){
                        if(respuesta.rows.success == true){
                            bootbox.alert({
                                message: "<h3><i class='fas fa-check-circle' style='color:#13b313'></i> Comisionista agregado exitosamente.</h3>",
                                locale: 'mx'
                            });
                            setTimeout("window.location.href = '"+base_url+"/addComisionista'", 3000);
                        }else{
                            bootbox.alert({
