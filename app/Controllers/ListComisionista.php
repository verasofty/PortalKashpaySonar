...
class ListComisionista extends BaseController{
	...
	public function index(){
		...
		return view('listComisionista/index', $datos);
	}
	...
	public function searchResult(){
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => WS_KASPAYSERVICES.'/portalKashPayServices/api/v1/entity/searchCommercesByLevel?contextID='.$_POST['subafiliado'].'&commissionAgentID=0&entityID=0&terminalID=0&level=7&nameCommerce='.$_POST['nameComerce'].'&bussinessName=&email='.$_POST['email'].'&telefono='.$_POST['tel'].'&rfc='.$_POST['rfc'].'&startDate='.$_POST['fechaInicio'].'&endDate='.$_POST['fechaFin'],
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => '',
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
