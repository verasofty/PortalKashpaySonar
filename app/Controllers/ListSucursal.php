...
class ListSucursal extends BaseController{
	...
	public function index(){
		...
		return view('listSucursal/index', $datos);
	}
	...
	public function searchResult(){
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => WS_KASPAYSERVICES.'/portalKashPayServices/api/v1/entity/searchCommercesByLevel?sirioId='.$prefijo.$_POST['subafiliado'].$_POST['entidad'].'&level=5&nameCommerce='.$_POST['nameComerce'].'&bussinessName=&email='.$_POST['email'].'&telefono='.$_POST['tel'].'&rfc='.$_POST['rfc'].'&startDate='.$_POST['fechaInicio'].'&endDate='.$_POST['fechaFin'],
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => '',
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 0,
