...
<header id="topbar" class="alt">
      <div class="topbar-left">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-current-item">Listar Comisionista
              </li>
          </ol>
      </div>
...
<!-- -------------- Page JS -------------- -->
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/listComisionista.js"></script>
...
<script type="text/javascript">
  $("#example1").DataTable({
      ...
      "buttons": [
            {
                extend: 'excelHtml5',
                title: 'Comisionistas-<?php echo $today_hora?>'
            },
            {
                extend: 'pdfHtml5',
                title: 'Comisionistas-<?php echo $today_hora?>'
