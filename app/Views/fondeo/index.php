  ...
  <div class="topbar-left">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-active">
        <a href="dashboard">Fondeo</a>
      </li>
      <li class="breadcrumb-link">
        <a href="dashboard">Home</a>
      </li>
      <li class="breadcrumb-current-item">Fondeo</li>
    </ol>
  </div>
        ...
        <div class="mw1000 center-block">
          ...
          <div class="allcp-form theme-primary">
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => URL_SERVICES.'/AldebaranServices/getEntityLevels?fatherId='.$_GET['validate'].'&level=8',
                ...
                <div class="row">
                  <div class="col-md-6">
                    <form id="form_caja" name="form_caja" method="post">
                      <input type="hidden" value="<?php echo $bName = ($numCajas == 0) ? 'Caja 1' : 'Caja 2' ;?>" name="bussinesName" >
                      <input type="hidden" value="<?php echo $bNameS = ($numCajas == 0) ? 'caja_1' : 'caja_2' ;?>" name="bussinesNameShort" >
                      <input type="hidden" value="<?php echo $aBundle = ($numCajas == 0) ? $_GET['validate'].'.caja1' : $_GET['validate'].'.caja2' ;?>" name="applicationBundle" >
                      <input type="hidden" value="<?php echo $_GET['validate']?>" name="fatherId" >
                      <input type="hidden" value="8" name="type" >   
                      <input type="hidden" value="assignClabeAccount" name="assignClabeAccount" >
                      <input type="hidden" value="<?php echo $active = ($numCajas == 0) ? 'true' : 'false' ;?>" name="active" >      
                    </form>
                    <button <?php echo $retVal = ($numCajas == 2) ? 'disabled' : '' ;?> id="crearCaja" class="btn btn-primary">NUEVA CAJA</button>
                  </div>  
                </div>
                <div class="row">
...
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/fondeo.js"></script>
