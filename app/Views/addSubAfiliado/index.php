  ...
  <div class="topbar-left">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-active">
        <a href="dashboard">Sub Afiliado</a>
      </li>
      <li class="breadcrumb-link">
        <a href="dashboard">Home</a>
      </li>
      <li class="breadcrumb-current-item">Agregar Sub Afiliado</li>
    </ol>
  </div>
      ...
      <div class="chute chute-center">
        <div class="mw1000 center-block">
          ...
          <div class="allcp-form">
            <form enctype="multipart/form-data" method="post" id="form-wizard">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="nombre" id="nombre" class="form-control" aria-describedby="nombreHelp">
                        ...
                        <div class="option-group field">
                          ...
                          <div class="col-md-4">
                            <div class="form-group divCuentaOtra">
                              ...
                              <input type="text" maxlength="18" class="form-control soloNum" id="cuentaKash" name="cuentaKash" aria-describedby="cpHelp">
...
<script src="<?php echo base_url()?>/public/assets/js/pages/forms-wizard-addSubAfiliado.js"></script>
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/addSubAfiliado.js"></script>
