                  ...
                  <div class="col-md-8">
                    <a href="#" class="">
                      <div class="tooltipsGen check_option_pay" data-value="transfer">  
                        <label class="circulo"> 
                          <img style="text-align: justify; margin-left: 0px;" class="logoPago" src="<?php echo base_url()?>/public/assets/img/iconos/Iconos/Orden de Pago/prepago.png">
                          <p>Checkout Kashpay</p>
                        </label>
                      </div>
                    </a>    
                  </div>
...
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/addPrepago.js"></script>
