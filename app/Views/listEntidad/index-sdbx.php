      ...
      <div class="topbar-left">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-active">
                  <a href="dashboard">Entidad</a>
              </li>
              <li class="breadcrumb-link">
                  <a href="dashboard">Home</a>
              </li>
              <li class="breadcrumb-current-item">Listar Entidad</li>
          </ol>
      </div>
...
<!-- -------------- Page JS -------------- -->
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/listEntidad.js"></script>
...
<script type="text/javascript">
  $("#example1").DataTable({
      ...
      "buttons": [
            {
                extend: 'excelHtml5',
                title: 'Entidades-<?php echo $today_hora?>'
            },
            {
                extend: 'pdfHtml5',
