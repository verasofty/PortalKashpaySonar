                    ...
                    <div class="col-md-6">
                      <div class="panel-heading pn text-center">
                        <span class="panel-title" style="color: #c7924b;">
                          ...
                          ¡Tu configuración esta completa!
                        </span>
                        <div style="height: 30px;"></div>
                        <p>
                          Ya puedes empezar a usar KashPay. Tambien lo puedes hacer desde tu smartphone.
                        </p>
                        <a href="http://kashplataforma.com.mx/adquirencia2" class="btn btn-bordered btn-primary">Continuar</a>
                      </div>
                    </div>
                    <div class="col-md-3"></div>
                  </div>
