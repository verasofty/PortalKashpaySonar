      ...
      <div class="topbar-left">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-active">
                  <a href="dashboard">Sucursal</a>
              </li>
              <li class="breadcrumb-link">
                  <a href="dashboard">Home</a>
              </li>
              <li class="breadcrumb-current-item">Listar Sucursal</li>
          </ol>
      </div>
              ...
              <div class="panel-body pn ">
                <form id="form_filtro" name="form_filtro" method="post">
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select <?php echo $retValSA = (session('idRol')!=2) ? 'disabled' : '' ; ?> class="form-control" id="subafiliado" name="subafiliado">
                          ...
                          <script type="text/javascript">
                            ...
                            var comiSelect = '<?php echo session('commissionAgentID') ?>';
                          </script>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select <?php echo $retValC = ( (session('idRol') == 2) || (session('idRol') == 3) ) ? '' : 'disabled' ; ?> class="form-control" id="comisionista" name="comisionista">
                        </select>
                      </div>
                    </div>
                        <?php 
                        ...
                        if ( ($retValC != '') ) {
                        ?>
                        <input type="hidden" value="<?php echo session('commissionAgentID')?>" name="comisionista">
                        <?php 
                        }
                        ?>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="nameComerce">Nombre del Comercio</label>
                        <input type="text" class="form-control" id="nameComerce" name="nameComerce">
                      </div>
                    </div>
              ...
              <div class="panel-body pn">
                <div class="table-responsive" style=" overflow: auto;">
                  ...
                  <table id="example1" class="table table-bordered table-striped" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th class="va-m">Nombre del Comercio</th>
                        <th class="va-m">Razón Social</th>
...
<!-- -------------- Page JS -------------- -->
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/listSucursal.js"></script>
...
<script type="text/javascript">
  $("#example1").DataTable({
      ...
      "buttons": [
            {
                extend: 'excelHtml5',
                title: 'Sucursales-<?php echo $today_hora?>'
            },
            {
                extend: 'pdfHtml5',
                title: 'Sucursales-<?php echo $today_hora?>'
