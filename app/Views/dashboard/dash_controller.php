	...
	public function index(){
		...
		if (session('idRol') == 2) {
			/*curl_setopt_array($curl, array(
			  CURLOPT_URL => WS_KASPAYSERVICES.'/portalKashPayServices/api/v1/dashboard/getConfig?idContext=0&idEntity=0&idTerminal=0&idTerminalUser=0&searchBy=0&startDate=&endDate=',
		...
		if (session('idRol') != 2) {
   			//if(session('mail') == 'OMAR.GUILLEN@GRUPOTIMEX.COM'){
