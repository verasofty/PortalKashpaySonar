...
<header id="topbar" class="alt">
      <div class="topbar-left">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-current-item">Agregar Sucursal</li>
          </ol>
      </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sucursal" name="sucursal" aria-describedby="sucursalHelp">
...
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/addSucursal.js"></script>
