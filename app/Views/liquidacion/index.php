      ...
      <div class="topbar-left">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-active">
                  <a href="#">Liquidacion</a>
              </li>
              <li class="breadcrumb-link">
                  <a href="dashboard">Home</a>
              </li>
              <li class="breadcrumb-current-item">Listar Liquidacion</li>
          </ol>
      </div>
...
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/liquidacion.js"></script>
