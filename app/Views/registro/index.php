            ...
            <div class="allcp-form theme-primary mw600" id="register">
                ...
                <div class="panel panel-primary">
                  ...
                  <form method="post" id="registroForm" name="registroForm">
                    <div class="panel-body pn">
                      ...
                      <div class="section">
                        <label for="negocio" class="field prepend-icon">
                          <input type="text" name="nombre" id="nombre" class="gui-input" placeholder="Nombre del Negocio*">
                      ...
                      <div class="section">
                        <label for="contrasena" class="field prepend-icon">
                          <input type="password" name="contrasena" id="contrasena" class="gui-input" placeholder="Contraseña*">
                      ...
                      <div class="section">
                        <label for="contrasenaCon" class="field prepend-icon">
                          <input type="password" name="contrasenaCon" id="contrasenaCon" class="gui-input" placeholder="Confirmar Contraseña*">
                      ...
                      <div class="section">
                          <div class="pull-right">
                              <a href="#" id="btn-add" class="btn btn-bordered btn-primary">Crear Cuenta
                              </a>
                          </div>
                      </div>
                      <!-- -------------- /section -------------- -->
                    ...
                    <p>Al dar clic en "Crear Cuenta" reconozco que soy mayor de edad y que acepto el <a target="_blank" href="https://onsigna.com/privacy-policy/">Aviso de Privacidad</a></p>
                    </div>
                    <!-- -------------- /Panel Footer -------------- -->
                  </form>
                </div>
...
<script src="<?php echo base_url()?>/public/assets/js/pages/portal/registro.js"></script>
